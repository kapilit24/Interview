namespace BTAHL7Schemas {
    ...
    [Microsoft.XLANGs.BaseTypes.DistinguishedFieldAttribute(typeof(System.String), "MSH.MSH.4_SendingFacility.HD.0_NamespaceId", XPath = @"/*[local-name()='MSH_25_GLO_DEF' and namespace-uri()='http://microsoft.com/HealthCare/HL7/2X']/*[local-name()='MSH' and namespace-uri()='']/*[local-name()='MSH.4_SendingFacility' and namespace-uri()='']/*[local-name()='HD.0_NamespaceId' and namespace-uri()='']", XsdType = @"string")]
    [Microsoft.XLANGs.BaseTypes.DistinguishedFieldAttribute(typeof(System.String), "MSH.MSH.9_MessageType.CM_MSG.0_MessageType", XPath = @"/*[local-name()='MSH_25_GLO_DEF' and namespace-uri()='http://microsoft.com/HealthCare/HL7/2X']/*[local-name()='MSH' and namespace-uri()='']/*[local-name()='MSH.9_MessageType' and namespace-uri()='']/*[local-name()='CM_MSG.0_MessageType' and namespace-uri()='']", XsdType = @"string")]
    [Microsoft.XLANGs.BaseTypes.DistinguishedFieldAttribute(typeof(System.String), "MSH.MSH.9_MessageType.CM_MSG.1_TriggerEvent", XPath = @"/*[local-name()='MSH_25_GLO_DEF' and namespace-uri()='http://microsoft.com/HealthCare/HL7/2X']/*[local-name()='MSH' and namespace-uri()='']/*[local-name()='MSH.9_MessageType' and namespace-uri()='']/*[local-name()='CM_MSG.1_TriggerEvent' and namespace-uri()='']", XsdType = @"string")]
...
<xs:schema xmlns=""http://microsoft.com/HealthCare/HL7/2X"" xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" targetNamespace=""http://microsoft.com/HealthCare/HL7/2X"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  ...
  <xs:element name=""MSH_25_GLO_DEF"">
    <xs:annotation>
      <xs:appinfo>
        <b:properties>
          <b:property distinguished=""true"" xpath=""/*[local-name()='MSH_25_GLO_DEF' and namespace-uri()='http://microsoft.com/HealthCare/HL7/2X']/*[local-name()='MSH' and namespace-uri()='']/*[local-name()='MSH.4_SendingFacility' and namespace-uri()='']/*[local-name()='HD.0_NamespaceId' and namespace-uri()='']"" />
          <b:property distinguished=""true"" xpath=""/*[local-name()='MSH_25_GLO_DEF' and namespace-uri()='http://microsoft.com/HealthCare/HL7/2X']/*[local-name()='MSH' and namespace-uri()='']/*[local-name()='MSH.9_MessageType' and namespace-uri()='']/*[local-name()='CM_MSG.0_MessageType' and namespace-uri()='']"" />
          <b:property distinguished=""true"" xpath=""/*[local-name()='MSH_25_GLO_DEF' and namespace-uri()='http://microsoft.com/HealthCare/HL7/2X']/*[local-name()='MSH' and namespace-uri()='']/*[local-name()='MSH.9_MessageType' and namespace-uri()='']/*[local-name()='CM_MSG.1_TriggerEvent' and namespace-uri()='']"" />
        </b:properties>
      </xs:appinfo>
    </xs:annotation>
    <xs:complexType>
